...
//         agregar_reproductor(ele.target.parentNode.dataid.id)  
//         console.log(ele.target)
//         Sumarid(parseInt(ele.target.parentNode.dataid.id) ) 
//         Restarid(parseInt(ele.target.parentNode.dataid.id))  
