...
<head>
    ...
    <link rel="stylesheet" href="barra_input.css">
...
<body class="body">
    <section class="cont-izquierdo">
        <header class="inicio_buscador">
           <div class="inicio">
            <img src="../imagenes/images/Mubes_logo.png" alt="">
           ...
           <div class="inputBox_container">
            ...
            <input class="inputBox" id="inputBox" type="text" placeholder="Buscar playlist...">
          </div>
        </header>
        <article class="playlist">
            <header class="cabeceraPlaylist">
            ...
            <section class="playlist_contenedor">
                <div class="playlist_individual">
                    <img src="" alt="">
    ...
    <script src="../album/prueba.js"></script>

    <section class="cont-derecho">

        <div class="row">

            <div id="cont_album" class="col-lg-6">
    
                <img class="portada_playlist" src="../imagenes/mas_gustaron.png" height="310px" width="310px">
    
                <div class="row">
                    
                        <div class="col-lg-10">
                            <div id="datos_playlist" class="container">  
                                <h2 class="titulo_playlist">Canciones que te gustan</h2>
                                <h3 class="creador_playlist">Mubes</h3>
                            </div>
                        </div> 
...
$sql = "SELECT * FROM canciones WHERE like_activo = '1'";
